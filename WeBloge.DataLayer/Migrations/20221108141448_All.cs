    ...
    public partial class All : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeBloges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeBloges_Categories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeBlogesId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_WeBloges_WeBlogesId",
                        column: x => x.WeBlogesId,
                        principalTable: "WeBloges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Webloge", true, "", true, false, "", 587, "smtp.gmail.com" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_WeBlogesId",
                table: "Comments",
                column: "WeBlogesId");
